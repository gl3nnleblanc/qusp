...
\section*{Introduction}
	...
	\begin{Figure}
		...
		\captionof{figure}{A graphical depiction of a scalar $c$, vector $v_i$, matrix $M_{ij}$, and a tensor $T_{ijk}$ of rank three.}
	...
	\begin{Figure}
		...
		\captionof{figure}{A graphical depiction of three examples of tensor contraction.}

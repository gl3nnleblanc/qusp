...
\section*{Matrix Product States}
	...
	where the first and last local tensors $A^{[1]}$ and $A^{[N]}$
	matrices and every other tensor in the chain is of rank three.
	...
	unsquashed into two indices of dimension $d$ each. The leftmost site
...
\section*{Package Overview}
	This section provides an overview of the meat of this project: a
